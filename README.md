Det här projektet innehåller automatiserade tester för användarregistrering på Basketball England. Testerna är skrivna i Java och använder verktygen Selenium WebDriver, Cucumber och JUnit.
